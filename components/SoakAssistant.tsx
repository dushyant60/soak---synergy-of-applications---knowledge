...
export const SoakAssistant = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: "model",
      text:
        "Hi! I am the SOAK Assistant. I can help you understand our services, explain tech concepts, or guide you through our process. How can I help?",
    },
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      console.error("SOAK Assistant error:", error);
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
          ...
          <div className="p-4 border-t border-slate-100 dark:border-slate-800 bg-white/40 dark:bg-slate-900/40 backdrop-blur-md">
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-teal-600 text-white rounded-full hover:bg-teal-700 disabled:opacity-50 transition-colors shadow-md hover:scale-105 active:scale-95"
              >
      ...
      <button
        ...
        className={`group flex items-center justify-center w-16 h-16 rounded-full shadow-2xl shadow-teal-900/30 transition-all duration-500 ${
          isOpen
